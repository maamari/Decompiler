...
This repository contains a simple, stack-based decompiler. The implementation is provided in three languages: Python (jupyter-notebook), Java, and C++. There are simplifiers in both the Python (jupyter-notebook) and C++ files but *not* in the Java file. 
