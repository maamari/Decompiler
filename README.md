...
This repository contains a simple, stack-based decompiler. The implementation is provided in three languages: Python (jupyter-notebook), Java, and C++. All three files operate in a similar manner. That being said, there are simplifiers in both the Python (jupyter-notebook) and the C++ implementations but *not* in the Java version. 
